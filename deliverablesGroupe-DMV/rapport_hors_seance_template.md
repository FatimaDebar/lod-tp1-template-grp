...
Dans ce tp on a etudier un jeu de donnes de data.gov.ma qui contient des etablissement on a bien etudier les donnes qu'il contient on a identifier ce qui nessecite de normalisation
